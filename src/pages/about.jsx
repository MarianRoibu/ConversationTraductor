  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text>
        I am a highly motivated and passionate full stack developer with experience in HTML, CSS, JavaScript, Node.js, PHP, MySQL, React, and Angular. I am a quick learner and excited to apply my skills to solve problems and face new challenges. I have great adaptability and work well both in a team and solo.        </Text>
...
Performed integration testing and code debugging to ensure the quality of the developed applications.        </Text>
